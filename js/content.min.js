...
return true;};var getElementInfo=function selectedElement(d){var f=function(m,k){var j={num:0,index:1};var h=0;var l=0;var g=m.previousSibling;var i=m.nextSibling;
...
}}j.num=h+l;j.index+=h;return j;};var c=function(n,l){var j=n.tagName.toLowerCase();var k=f(n,l);if(l){var m=new Array();var i=["@type=","@class=","@name=","@id="];
...
}}if(k.num>0){j+="["+k.index+"]";}return j;};var a=function(g){return b("//"+g.tagName.toLowerCase()+"[@id='"+g.id+"']");};var e=function(j,i){var h=c(j,i);
var g=j.parentNode;while(g.tagName){if(!i){if(j.id!==""){return a(j);}if(g.id!==""){return a(g)+"/"+h;}}h=c(g,i)+"/"+h;g=g.parentNode;}return b(h);};var b=function(g){return g.replace(/^((\/){0,2}html)/,"/html");
};return e(d,false);};